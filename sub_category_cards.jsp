                ...
                <c:forEach var="subCat" items="${subCats}">
                    <div class="card md-4 mb-3 d-inline-block" style="max-width: 700px; border: 1px solid black;">
                        <div class="card" style="width: 21rem;">
                            <img src="${subCat.pic}" class="card-img-top" style="height: 200px; border: solid 1px black; margin: 3px3px" >
                            <div class="card-body" style="height: 230px">
                                <hr>
                                <h6 class="card-title">${subCat.desc}</h6>
                                <div class="text-left">
                                    <a href="sub_blog_cards.do?scId=${subCat.subCategoryId}" class="btn primary-background text-white">Blogs of ${subCat.name}</a>
                                </div>
                            </div>
                        </div>
                    </div>
